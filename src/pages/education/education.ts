...
export class EducationPage {
	...
	fetchNets() {
		this.loading = this.loadingCtrl.create({
			content: 'Fetching Educational Payments...'
		});
		this.loading.present();
		this.web.getEducation().then(
	...
	pay(){
		...
		const browser = this.iab.create(this.web.siteaddress2+'process_transaction.php?email='+this.email+'&phone='+this.phone+'&amount='+this.amount+'&billersCode='+this.phone+'&serviceID='+ntwk+'&variation='+pln+'&convenienceFee=100&type=tv', '_blank', { hardwareback: 'no', location: 'yes'});
